 ...
 * @author nafea8846
 */
public class SleepyMarioBros_GoombaTest extends JComponent implements ActionListener {
    ...
    Rectangle block = new Rectangle(400, 530, 50, 50);
    ...
    int goombaSpeed = 5;
    boolean dead = false;
    int timer = desiredFPS/8;
    int blockTime = timer;
    // GAME VARIABLES END HERE    

    // Constructor to create the Frame and place the panel in
    // You will learn more about this in Grade 12 :)
    public SleepyMarioBros_GoombaTest() {
    ...
    public void loop() {
        ...
        if(reactionTop && block.height != 25){
    ...
    public static void main(String[] args) {
        ...
        SleepyMarioBros_GoombaTest game = new SleepyMarioBros_GoombaTest();
    }
}
